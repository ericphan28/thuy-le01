...
import { ArrowLeft, Save, Package, Loader2, Edit } from "lucide-react"
    ...
    const loadData = async () => {
      ...
      try {
        ...
        setFormData({
          ...
          storage_location: (product as any).storage_location || '',
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-gray-600">Cập nhật thông tin sản phẩm: {originalProduct.product_name}</p>
          </div>
        </div>
      ...
      <Card>
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                <Label htmlFor="storage_location">Vị Trí Lưu Trữ</Label>
                <Input
                  id="storage_location"
