# 🤖 Copilot Context Hub (Auto-load)

Always read in this order for new sessions:

1) `AI_CONTEXT.md` → Recent Updates + full project context
2) `PROJECT_STATUS.md` → Current implementation and roadmap
3) `README.md` → Tech stack and architecture
4) `BUSINESS_ANALYSIS.md` → Business domain rules

Key deltas (Aug 19, 2025): use RPC `search_debt_customers` for “Có nợ”, compact invoice print with company header and total debt, POS shows total debt.
