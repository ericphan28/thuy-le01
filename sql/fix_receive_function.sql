-- =====================================================
-- Simple fix: Update inbound receive function to work with existing schema
-- Date: 2025-08-17
-- =====================================================

-- Update receive function to use correct parameter names
...
BEGIN
  ...
  FOR v_line IN SELECT * FROM jsonb_array_elements(p_lines) LOOP
    ...
    -- Create stock movement using existing function signature
