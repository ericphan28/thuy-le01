      ...
      <CardContent className="p-4 space-y-4">
        ...
        {customer && (
          <div className="bg-muted/30 rounded-lg p-3">
            ...
            <div className="grid grid-cols-2 gap-2 text-xs">
              ...
              <div>
                <span className="text-muted-foreground">Sau GD:</span>
        ...
        <div className="bg-brand/10 rounded-lg p-3 border border-brand/20">
          <div className="flex items-center justify-between">
            <span className="text-sm text-brand">Tổng thanh toán:</span>
        ...
        <div className="grid grid-cols-2 gap-2 pt-2">
          ...
          <Button
            ...
            className="h-9 text-sm bg-brand hover:bg-brand/90 text-brand-foreground disabled:opacity-50"
          >
            {loading ? (
